...
function builder(options) {
  ...
  if (!options.network) {
    options.network = ravencore.Networks.defaultNetwork;
  }

  options.Block = options.Block || ravencore.Block;
  options.BlockHeader = options.BlockHeader || ravencore.BlockHeader;
  options.Transaction = options.Transaction || ravencore.Transaction;
  options.MerkleBlock = options.MerkleBlock || ravencore.MerkleBlock;
