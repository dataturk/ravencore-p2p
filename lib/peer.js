 ...
 * using the standard Ravencoin protocol. A Peer instance represents one connection
 * on the Ravencoin network. To create a new peer connection provide the host and port
